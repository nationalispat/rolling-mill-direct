...
const ProductsSection = () => {
  return (
    <section id="products" className="py-28 md:py-36 bg-section-alt overflow-hidden">
      <div className="container">
        <ScrollReveal variant="tilt">
          <div className="text-center max-w-lg mx-auto mb-16">
            <div className="gold-line mx-auto mb-6" />
            <p className="text-gold font-semibold text-xs uppercase tracking-[0.25em] mb-4">Products</p>
          ...
          <ScrollReveal variant="fade-left">
            <div className="relative">
              <img
                ...
                width={1280}
                height={960}
                className="rounded-2xl w-full object-cover aspect-[3/4] lg:sticky lg:top-24 shadow-premium"
              />
              <div className="absolute -top-3 -left-3 w-20 h-20 border-2 border-gold/15 rounded-2xl" />
            </div>
          </ScrollReveal>
          ...
          <div className="space-y-5">
            {products.map((product, i) => (
              <ScrollReveal key={product.name} variant="card" delay={i * 0.05}>
                <div className="bg-card rounded-2xl p-7 border border-border hover:border-gold/30 hover:shadow-premium-hover transition-all duration-500 group">
