...
// Placeholder for rolling mill photos - replace src with actual images
    ...
    <section id="gallery" className="py-24 md:py-32">
      <div className="container">
        <div className="text-center max-w-lg mx-auto mb-16">
          <p className="text-forge font-semibold text-xs uppercase tracking-[0.2em] mb-4">
            Gallery
          </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
          {rollingMillImages.map((img) => (
            <div
              key={img.label}
              className="relative overflow-hidden rounded-xl aspect-video bg-muted flex items-center justify-center border border-dashed border-border"
            >
              {img.src ? (
                <img
                  src={img.src}
